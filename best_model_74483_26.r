...
TRAIN_FILE_BEST <- Sys.getenv("TRAIN_FILE", "train.csv")
TEST_FILE_BEST <- Sys.getenv("TEST_FILE", "test.csv")
OUTPUT_FILE_BEST <- Sys.getenv("OUTPUT_FILE", "submission_best_74564_76.csv")
VALIDATION_FILE_BEST <- "validation_best_74564_76.csv"
...
if (!file.exists(TRAIN_FILE_BEST)) stop("Не найден train: ", TRAIN_FILE_BEST)
if (!file.exists(TEST_FILE_BEST)) stop("Не найден test: ", TEST_FILE_BEST)
